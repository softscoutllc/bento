# Contributing to SoftScout PDF

First off, thank you for considering contributing to **SoftScout PDF**! Your help makes this project better for everyone.
...
Before we can accept your contributions, you must sign our Contributor License Agreement (CLA). This is required because SoftScout PDF uses a dual licensing model:
...
If you are contributing on behalf of your employer, your organization needs to sign our [Corporate Contributor License Agreement (CCLA)](CCLA.md). Please contact us at [contact@softscout.net](mailto:contact@softscout.net) to arrange corporate CLA signing.
...
**Email:** [contact@softscout.net](mailto:contact@softscout.net)
...
Thank you for helping make **SoftScout PDF** a better library for everyone!
